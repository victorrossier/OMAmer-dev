#!/usr/bin/env python
'''
    Full and reduced alphabets -- not functional yet.

    (C) 2019 Alex Warwick Vesztrocy <alex@warwickvesztrocy.co.uk>

    This file is part of Orlov.

    Orlov is free software: you can redistribute it and/or modify
    it under the terms of the GNU Lesser General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    Orlov is distributed in the hope that it will be useful,
    but WITHOUT ANY WARRANTY; without even the implied warranty of
    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
    GNU Lesser General Public License for more details.

    You should have received a copy of the GNU Lesser General Public License
    along with Orlov.  If not, see <http://www.gnu.org/licenses/>.
'''
import numpy as np
